...
setGlobals HUS
set -x
peer channel update -f ${TEST_NETWORK_HOME}/channel-artifacts/org4_update_in_envelope.pb -c ${CHANNEL_NAME} -o localhost:7050 --ordererTLSHostnameOverride orderer --tls --cafile "$ORDERER_CA"
{ set +x; } 2>/dev/null
